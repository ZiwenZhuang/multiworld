...
from multiworld.envs.gym_robotics_visual import fetch_env
...
class FetchPushEnv(fetch_env.FetchEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', distance_threshold=0.05, **kwargs):
        ...
        fetch_env.FetchEnv.__init__(
            ...
            initial_qpos=initial_qpos, reward_type=reward_type, object_location_same_as_gripper_probability=0.0,
            **kwargs)
