...
from multiworld.envs.gym_robotics_visual import hand_env
from multiworld.envs.gym_robotics_visual.utils import robot_get_obs
...
class HandReachEnv(hand_env.HandEnv, utils.EzPickle):
    ...
    def _get_obs(self):
        ...
        observation = self.get_image_obs(depth=True)
        # TODO Change this into image goal
        return {
